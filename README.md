...
| GATEWAY_1_HOST | URL of the first target endpoint your request will be sent | string | - | Yes |
| GATEWAY_1_SIGNING_HOST | URL of the first target endpoint that is used to generate the signature | string | - | Yes |

...
exports.getConfig = () => {
    const { DEBUG, SECURE, AUTH_MODE, LOCAL_PORT, GATEWAY_1_HOST, GATEWAY_1_PORT, GATEWAY_1_TYPE, GATEWAY_1_URL_PREFIX, GATEWAY_1_APP_ID, GATEWAY_1_SECRET, GATEWAY_1_KEY_STRING, GATEWAY_1_KEY_FILE, GATEWAY_2_HOST, GATEWAY_2_PORT, GATEWAY_2_TYPE, GATEWAY_2_URL_PREFIX, GATEWAY_2_APP_ID, GATEWAY_2_SECRET, GATEWAY_2_KEY_STRING, GATEWAY_2_KEY_FILE, } = process.env;
    return {
        ...
        gateway1KeyFile: GATEWAY_1_KEY_FILE ? path_1.default.join(__dirname, '..', GATEWAY_1_KEY_FILE) : undefined,
        ...
        gateway2KeyFile: GATEWAY_2_KEY_FILE ? path_1.default.join(__dirname, '..', GATEWAY_2_KEY_FILE) : undefined,
    };
};
exports.printConfig = () => {
